...
import jumper from '../src/imagesmisc/stander.JPG'
import $ from "jquery";
...
<Navbar className = "bsnavbar" sticky = "top" expand = "sm">
  ...
  <section className="et-hero-tabs" id ='home'>
    ...
    <div className = "new-title"><h3 className = "new-actual">We are: After Hours</h3></div> 
    <p className = "new-actual">ROCHESTER'S PREMIERE ACAPELLA GROUP</p>

  </section>
</div>
<main className="et-main-about">
  <div className ="content-holder">
    <div className = "scroller" id = "about">
      <section className="et-slide-about" id="about">
        ...
        <h1 className = "about-about-heading-text">ABOUT AFTER HOURS</h1>
